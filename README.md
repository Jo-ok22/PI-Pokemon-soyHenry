...
-  Obtiene un arreglo de objetos, donde cada objeto es un pokemon con su información.  "1"
...
-  Esta ruta debe obtener todos aquellos pokemons que coinciden con el nombre recibido por query."1"
-  Debe poder buscarlo independientemente de mayúsculas o minúsculas."1"
-  Si no existe el pokemon, debe mostrar un mensaje adecuado. "1"
-  Debe buscar tanto los de la API "1" como los de la base de datos.
...
-  Obtiene un arreglo con todos los tipos de pokemones. "1"
-  En una primera instancia, cuando la base de datos este vacía, deberás guardar todos los tipos que encuentres en la API. "1"
-  Estos deben ser obtenidos de la API (se evaluará que no haya hardcodeo). Luego de obtenerlos de la API, deben ser guardados en la base de datos para su posterior consumo desde allí. "1"
